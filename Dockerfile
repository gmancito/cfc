...
# Move php.ini into container
COPY config/php.ini /usr/local/etc/php/php.ini

# ###################################
# # PROXY setup so that the linux box can pull from the internet
# # when behind corporate proxy, $PROXY is a variable passed in
# ARG PROXY
# ENV PROXY $PROXY
...
# RUN cd /tmp && wget http://www.dotdeb.org/dotdeb.gpg && apt-key add dotdeb.gpg
...
# & \
# chown -hR root:www-data /opt/microsoft
